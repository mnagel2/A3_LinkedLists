...
public class BasicDoubleLinkedListTest {
	...
	@Test
	public void testIteratorNoSuchElementExceptionPrevious() { //Starts with b:"Jeep" and c:"Honda"
		linkedCar.addToFront(a);
		linkedCar.addToEnd(d);
		ListIterator<Car> iteratorCar = linkedCar.iterator();		
		assertEquals(true, iteratorCar.hasNext());
	...
	@Test
	public void testIteratorUnsupportedOperationException() { 		//Starts with b:"Jeep" and c:"Honda"
		linkedCar.addToFront(a);									//a:"Ford",b:"Jeep,c:"Honda"
		linkedCar.addToEnd(d);										//a:"Ford",b:"Jeep,c:"Honda",d:"Subaru"
		ListIterator<Car> iteratorCar = linkedCar.iterator();		
		assertEquals(true, iteratorCar.hasNext());
		assertEquals(a, iteratorCar.next());
		assertEquals(b, iteratorCar.next());						//Should be b:"Jeep"
		assertEquals(c, iteratorCar.next());
		assertEquals(true, iteratorCar.hasNext());
		assertEquals(d, iteratorCar.next());
	...
	@Test
	public void testRetrieveFirstElement() {				// Has elements b and c already
		assertEquals(b, linkedCar.getFirst());				// Displays b without changing list
		linkedCar.addToFront(a);							// Adds element a to front {a,b,c}
		assertEquals(a, linkedCar.getFirst());				// Displays a
