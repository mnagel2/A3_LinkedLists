...
public class SortedDoubleLinkedListTest {
	...
	/*e*/ public Car a=new Car("Ford", "F150", 2005);
	/*f*/ public Car b=new Car("Jeep", "Renegade", 2005);
	/*a*/ public Car c=new Car("Honda", "Civic", 2005);
	/*c*/ public Car d=new Car("Subaru", "Outback", 2005);
	/*b*/ public Car e=new Car("Chevrolet", "Silverado", 2005);
	/*d*/ public Car f=new Car("Chrysler", "PTCruiser", 2005);
	...
	public void testIteratorSuccessfulStringPrevious() {
		...
		System.out.println("About to check Zebra");
